...
SELECT brands.name, models.name, year, founded 
FROM Brands
...
-- Inner joins capture the intersection of data that are present in both tables.
-- The fields match exactly and they have no missing information across the columm
-- that you are joining at. With left joins, you are mapping all the column information
-- of one table onto a nother column of another table. So you are getting all of the information
-- of the table that you are using, and you are getting matching information of the table that you are
-- joining.
